...
def rasa_greeting(user_input):
    ...
    # ✅ FIX 3: Exact match instead of substring
    if user_text in farewell_triggers:
        _greeted = False
        _last_greeting_index = None
        return random.choice(farewell_responses)

    # ✅ FIX 4: Exact match greeting
    if user_text in first_time_greetings:
    ...
    # ✅ FIX 5: Exact match continuer
    if _greeted and user_text in post_query_continuers:
